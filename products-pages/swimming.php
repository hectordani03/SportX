...
<body>
    ...
    <main>
        <section class="img-soccer">
            <img src="../assets/swimming.webp" alt="">
            <?php
        ...
        <section class="secciones">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Footwear' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Footwear' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Footwear' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
            ...
            <div class="swimsuit">
                <div data-title>
                    <h1 id="swimsuit">Swimsuit</h1>
                    <div class="splide splide-man">
                        <div class="splide__track">
                            <h2 id="swimsuitman">Man</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Swimsuit' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            <h2 id="swimsuitwoman">Woman</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Swimsuit' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            <h2 swimsuitkid>Kids</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Swimsuit' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
            ...
            <div class="balls">
                <div data-title>
                    <h1 id="googles">Googles</h1>
                    <div class="splide splide-man">
                        <div class="splide__track">
                            <h2 id="googlesadult">Adult</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Googles' AND section = 'A'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            <h2 id="googleskid">Kids</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Googles' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Swimming' AND product_type = 'Accessories'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
