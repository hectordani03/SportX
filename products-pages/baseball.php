...
<body>
    ...
    <main>
        <section class="img-soccer">
            <img src="../assets/baseball.webp" alt="">
            <?php
        ...
        <section class="secciones">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Footwear' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Footwear' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Footwear' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Jerseys' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Jerseys' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Jerseys' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
            ...
            <div class="bottom">
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            <h2 id="batsadult">Adult</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Bats' AND section = 'A'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            <h2 id="batskid">Kids</h2>
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Bats' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Bottoms' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Bottoms' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Bottoms' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Balls'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Baseball' AND product_type = 'Accessories'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
