...
<body>
    ...
    <main>
        <section class="img-soccer">
            <img src="../assets/football.webp" alt="">
            <?php
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Footwear' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Footwear' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Footwear' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Jerseys' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Jerseys' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Jerseys' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Bottoms' AND section = 'M'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-woman">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Bottoms' AND section = 'W'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-kids">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Bottoms' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Balls'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Accessories'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                ...
                <div data-title>
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Protections' AND section = 'A'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
                    ...
                    <div class="splide splide-man">
                        <div class="splide__track">
                            ...
                            <ul class="splide__list">
                                <?php
                                $sql = $conne->prepare("SELECT * FROM products WHERE category = 'Football' AND product_type = 'Protections' AND section = 'K'");
                                $sql->execute();
                                $img = $sql;
                                foreach ($img as $img_loop) {  ?>
                                    <li class="splide__slide" style="width: 250px">
