...
<nav class="menu-secciones">
    <div class="dropdown">
        ...
        <div class="dropdown-content"> 
            <a rel="noopener" target="_blank" href="index.php">Nuevo</a>
            <a rel="noopener" target="_blank" href="index.php">Lista</a>
            <a rel="noopener" target="_blank" href="index.php">Buscar</a>
        </div>
    </div>
    <div class="dropdown">
